...
public class ServerGame {
	...
	public String processBroadcast(Mailbox player, String msg) {
		...
		if(split[1].equals(MessageConstants.TIME_OUT)) {
			return MessageConstants.TIME_OUT;
		}
		if(split[1].equals(MessageConstants.START_TIMER)) {
			return MessageConstants.START_TIMER;
		}
		return "";
	}
