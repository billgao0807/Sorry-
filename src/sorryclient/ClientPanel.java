...
public class ClientPanel extends JPanel implements Listener {
	...
	public void listen(String msg) {
		...
		if(msg.contains(MessageConstants.TIME_OUT)) {
//			System.out.println("Client panel: received time out signal ending turn");
			gameManager.endTurn();
		}
		if(msg.contains(MessageConstants.START_TIMER)) {
//			System.out.println("Client Panel: start timer");
